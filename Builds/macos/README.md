...
We don't recommend macos for jbcoind production use at this time. Currently, the
...
modification, build jbcoind using clang, and run the system tests you will need
...
should satisfy the the minimum version requirements for jbcoind.
...
listed on [GitHub](https://github.com/jbcoin/jbcoind/releases GitHub). 
