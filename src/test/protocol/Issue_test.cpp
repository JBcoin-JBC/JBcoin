...
#ifndef JBCOIN_ASSETS_ENABLE_STD_HASH
# if BEAST_MAC || BEAST_IOS
#  define JBCOIN_ASSETS_ENABLE_STD_HASH 0
# else
#  define JBCOIN_ASSETS_ENABLE_STD_HASH 1
# endif
#endif
...
#if JBCOIN_ASSETS_ENABLE_STD_HASH
...
BEAST_DEFINE_TESTSUITE(Issue,protocol,jbcoin);
