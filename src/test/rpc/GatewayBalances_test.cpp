...
public:
    ...
    testGWB(FeatureBitset features)
    {
        ...
        if (wsc->version() == 2)
        {
            ...
            expect(jv.isMember(jss::jbcoinrpc) && jv[jss::jbcoinrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(GatewayBalances,app,jbcoin);
