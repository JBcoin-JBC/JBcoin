   ...
   void testSignerListsV2()
    {
        ...
        // Alice has no SignerList yet.
        {
            ...
            BEAST_EXPECT(info.isMember(jss::jbcoinrpc) && info[jss::jbcoinrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(info[0u].isMember(jss::jbcoinrpc) && info[0u][jss::jbcoinrpc] == "2.0");
            ...
            BEAST_EXPECT(info[1u].isMember(jss::jbcoinrpc) && info[1u][jss::jbcoinrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountInfo,app,jbcoin);
