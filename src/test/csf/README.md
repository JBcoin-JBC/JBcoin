...
controlled manner. It is also used to unit test the generic JBCoin consensus
...
completely abstracted from the details of the JBC ledger and transactions. In
