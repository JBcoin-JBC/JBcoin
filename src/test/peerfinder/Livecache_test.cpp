...
public:
    ...
    void testHistogram ()
    {
        ...
        for (auto i = 0; i < num_eps; ++i)
            add(
                ...
                c,
                jbcoin::rand_int(0, static_cast<int>(Tuning::maxHops + 1)));
    ...
    void testShuffle ()
    {
        ...
        using at_hop = std::vector <jbcoin::PeerFinder::Endpoint>;
...
BEAST_DEFINE_TESTSUITE(Livecache,peerfinder,jbcoin);
