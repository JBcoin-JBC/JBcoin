...
#ifndef JBCOIN_TEST_JTX_FLAGS_H_INCLUDED
#define JBCOIN_TEST_JTX_FLAGS_H_INCLUDED
...
private:
    ...
    set_args (std::uint32_t flag)
    {
        ...
        case asfDisallowJBC:    mask_ |= lsfDisallowJBC;    break;
        ...
        case asfDefaultJBCoin:  mask_ |= lsfDefaultJBCoin;  break;
