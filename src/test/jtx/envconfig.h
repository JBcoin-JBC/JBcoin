...
#ifndef JBCOIN_TEST_JTX_ENVCONFIG_H_INCLUDED
#define JBCOIN_TEST_JTX_ENVCONFIG_H_INCLUDED
...
/// jbcoin::Config. The function takes ownership of the unique_ptr and
