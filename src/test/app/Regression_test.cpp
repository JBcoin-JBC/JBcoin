...
struct Regression_test : public beast::unit_test::suite
{
    ...
    void testOffer1()
    {
        ...
        env(offer("alice", USD(10), JBC(10)), require(owners("alice", 1)));
        env(offer("alice", USD(20), JBC(10)), json(R"raw(
                { "OfferSequence" : 2 }
    ...
    {
        testcase("Account balance < fee destroys correct amount of JBC");
        using namespace jtx;
        Env env(*this);
        env.memoize("alice");
        ...
        auto const aliceJBC = 400;
        auto const aliceAmount = JBC(aliceJBC);
            ...
            env.app().timeKeeper().closeTime());
        {
            ...
            auto const result = jbcoin::apply(env.app(),
        ...
        }
        {
            ...
            BEAST_EXPECT(balance == JBC(0));
        }
        expectedDrops -= aliceJBC * dropsPerJBC<int>::value;
        BEAST_EXPECT(next->info().drops == expectedDrops);
    }
...
BEAST_DEFINE_TESTSUITE(Regression,app,jbcoin);
