...
#ifndef JBCOIN_RPC_SERVERHANDLERIMP_H_INCLUDED
#define JBCOIN_RPC_SERVERHANDLERIMP_H_INCLUDED

#include <jbcoin/core/JobQueue.h>
#include <jbcoin/rpc/impl/WSInfoSub.h>
...
#include <jbcoin/app/main/CollectorManager.h>
