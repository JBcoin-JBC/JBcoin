...
#ifndef JBCOIN_SERVER_SSLHTTPPEER_H_INCLUDED
#define JBCOIN_SERVER_SSLHTTPPEER_H_INCLUDED

#include <jbcoin/server/impl/BaseHTTPPeer.h>
#include <jbcoin/server/impl/SSLWSPeer.h>
