...
#ifndef JBCOIN_NODESTORE_BATCHWRITER_H_INCLUDED
#define JBCOIN_NODESTORE_BATCHWRITER_H_INCLUDED

#include <jbcoin/nodestore/Scheduler.h>
#include <jbcoin/nodestore/Task.h>
#include <jbcoin/nodestore/Types.h>
