...
#ifndef JBCOIN_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
#define JBCOIN_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
...
public:
    ...
    */
    ...
    closeAgree() const
    {
        return jbcoin::getCloseAgree(ledger_->info());
    }
