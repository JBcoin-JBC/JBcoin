...
#ifndef JBCOIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
#define JBCOIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
...
private:
    ...
    {
        return {jbcoinCalc_, pathState_, multiQuality_, j_, nodeIndex_ + delta};
    }
