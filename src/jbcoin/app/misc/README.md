...
The JBCoin payment protocol enforces a fee schedule expressed in units of the
native currency, JBC. Fees for transactions are paid directly from the account
...
may want to change fees is when the value of the native currency JBC fluctuates
...
The JBCoin consensus algorithm allows distributed participants to arrive at
...
A validating instance of jbcoind uses information in the configuration file
...
consensus to succeed, otherwise different instances of jbcoind will get 
...
*  A pull request is created and the new code is folded into a jbcoind build 
