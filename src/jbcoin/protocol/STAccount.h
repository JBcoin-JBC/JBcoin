...
#ifndef JBCOIN_PROTOCOL_STACCOUNT_H_INCLUDED
#define JBCOIN_PROTOCOL_STACCOUNT_H_INCLUDED
...
private:
    ...
    // overhead in a jbcoin::uint160.  However, so the serialized format of the
