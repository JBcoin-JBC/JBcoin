...
#ifndef JBCOIN_PROTOCOL_ISSUE_H_INCLUDED
#define JBCOIN_PROTOCOL_ISSUE_H_INCLUDED
...
/** Returns an asset specifier that represents JBC. */
inline Issue const& jbcIssue ()
{
    static Issue issue {jbcCurrency(), jbcAccount()};
    return issue;
}
